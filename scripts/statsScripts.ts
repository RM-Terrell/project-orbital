...
function semToSd() {
  var sem = parseFloat((<HTMLInputElement>document.getElementById("semInput")).value);
  var nValue = parseFloat((<HTMLInputElement>document.getElementById("nValueInput")).value);
...
function percToPerc() {
  ...
  (<HTMLInputElement>document.getElementById("percToPercResult")).value = result;
}
